...
module.exports = app => {
    ...
    WHERE "p"."Id_perfil" = :Id_perfil
        ...
        AND ("pc"."Id_perfil" NOT IN (
            ...
            FROM public."Matches" AS "m"
            WHERE "m"."Id_perfil_destino" = "p"."Id_perfil" AND "m"."Id_tipo_match" = 1 AND "m"."Id_estado" <> 3
        ))
        AND ("rc"."Id_raza" IN (
            SELECT "pr"."Id_raza"
    ...
    WHERE "p"."Id_perfil" = :Id_perfil
        ...
        AND ("pc"."Id_perfil" NOT IN (
            SELECT "m"."Id_perfil_origen"
            FROM public."Matches" AS "m"
            WHERE "m"."Id_perfil_destino" = "p"."Id_perfil" AND "m"."Id_tipo_match" = 2 AND "m"."Id_estado" <> 3
        ))
        AND ("rc"."Id_raza" IN (
            SELECT "pr"."Id_raza"
            FROM public."Preferencia_Raza" AS "pr"
